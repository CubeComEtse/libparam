...
{
    reg_Board_ID_addr                        = 0x10, // 16
    reg_FW_Version_addr                      = 0x11, // 17
    reg_HW_Version_addr                      = 0x12, // 18
    reg_Scratchpad_addr                      = 0x13, // 19
    reg_Supported_Boards_addr                = 0x14, // 20
    reg_Configured_Boards_addr               = 0x15, // 21
    reg_Uptime_addr                          = 0x16, // 22
    reg_Event_ConfA_addr                     = 0x17, // 23
    reg_Event_addr                           = 0x18, // 24
    reg_ConfPower_addr                       = 0x20, // 32
    reg_MeasureVI_V3_addr                    = 0x21, // 33
    reg_MeasurePower_V3_addr                 = 0x22, // 34
    reg_MeasureVI_V5_addr                    = 0x23, // 35
    reg_MeasurePower_V5_addr                 = 0x24, // 36
    reg_MeasureVI_VBat_addr                  = 0x25, // 37
    reg_MeasurePower_VBat_addr               = 0x26, // 38
    reg_MeasureVI_VBatAlt_addr               = 0x27, // 39
    reg_MeasurePower_VBatAlt_addr            = 0x28, // 40
    reg_I2CConfA_addr                        = 0x29, // 41
    reg_I2CConfB_addr                        = 0x2A, // 42
    reg_MultiConf0_addr                      = 0x2B, // 43
    reg_ConfTempSense_addr                   = 0x2C, // 44
    reg_CANConfA_addr                        = 0x2D, // 45
    reg_CANConfB_addr                        = 0x2E, // 46
    reg_SerialConf_addr                      = 0x2F, // 47
    reg_PC104Pins_addr                       = 0x30, // 48
    reg_XTXMultitester_addr                  = 0x31, // 49
    reg_RFRelaysConf_addr                    = 0x32, // 50
    reg_MultiConf1_Status_addr               = 0x33, // 51
    reg_MultiConf1_Set_addr                  = 0x34, // 52
    reg_MultiConf1_Clear_addr                = 0x35, // 53
    reg_XDCConfig_addr                       = 0x40, // 64
    reg_CSBoard_T0_addr                      = 0x50, // 80
    reg_CSBoard_T1_addr                      = 0x51, // 81
    reg_CSBoard_T2_addr                      = 0x52, // 82
    reg_CSBoard_T3_addr                      = 0x53, // 83
    reg_CSBoard_T4_addr                      = 0x54, // 84
    reg_CSBoard_T5_addr                      = 0x55, // 85
    reg_CSBoard_T6_addr                      = 0x56, // 86
    reg_CSBoard_T7_addr                      = 0x57, // 87
    reg_CSBoard_Current0I0_addr              = 0x58, // 88
    reg_CSBoard_Current0I1_addr              = 0x59, // 89
    reg_CSBoard_Current0I2_addr              = 0x5A, // 90
    reg_CSBoard_Current1I0_addr              = 0x5B, // 91
    reg_CSBoard_Current1I1_addr              = 0x5C, // 92
    reg_CSBoard_Current1I2_addr              = 0x5D, // 93
    reg_CSBoard_Current2I0_addr              = 0x5E, // 94
    reg_CSBoard_Current2I1_addr              = 0x5F, // 95
    reg_CSBoard_Current2I2_addr              = 0x60, // 96
    reg_CSBoard_Current3I0_addr              = 0x61, // 97
    reg_CSBoard_Current3I1_addr              = 0x62, // 98
    reg_CSBoard_Current3I2_addr              = 0x63, // 99
    reg_CSBoard_Current4I0_addr              = 0x64, // 100
    reg_CSBoard_Current4I1_addr              = 0x65, // 101
    reg_CSBoard_Current4I2_addr              = 0x66, // 102
    reg_CSBoard_Current5I0_addr              = 0x67, // 103
    reg_CSBoard_Current5I1_addr              = 0x68, // 104
    reg_CSBoard_Current5I2_addr              = 0x69, // 105
    reg_CSBoard_Current6I0_addr              = 0x6A, // 106
    reg_CSBoard_Current6I1_addr              = 0x6B, // 107
    reg_CSBoard_Current6I2_addr              = 0x6C, // 108
    reg_CSBoard_Current7I0_addr              = 0x6D, // 109
    reg_CSBoard_Current7I1_addr              = 0x6E, // 110
    reg_CSBoard_Current7I2_addr              = 0x6F, // 111
    reg_TE_Addr_0_addr                       = 0x80, // 128
    reg_TE_Addr_0_Set_addr                   = 0x81, // 129
    reg_TE_Addr_0_Clear_addr                 = 0x82, // 130
    reg_TE_Addr_1_addr                       = 0x83, // 131
    reg_TE_Addr_1_Set_addr                   = 0x84, // 132
    reg_TE_Addr_1_Clear_addr                 = 0x85, // 133
    reg_TE_Addr_2_addr                       = 0x86, // 134
    reg_TE_Addr_2_Set_addr                   = 0x87, // 135
    reg_TE_Addr_2_Clear_addr                 = 0x88, // 136
    reg_TE_Addr_3_addr                       = 0x89, // 137
    reg_TE_Addr_3_Set_addr                   = 0x8A, // 138
    reg_TE_Addr_3_Clear_addr                 = 0x8B, // 139
    reg_MTC_Addr_0_addr                      = 0xB0, // 176
    reg_MTC_Addr_0_Set_addr                  = 0xB1, // 177
    reg_MTC_Addr_0_Clear_addr                = 0xB2, // 178
    reg_MTC_Addr_1_addr                      = 0xB3, // 179
    reg_MTC_Addr_1_Set_addr                  = 0xB4, // 180
    reg_MTC_Addr_1_Clear_addr                = 0xB5, // 181
    reg_MTC_Addr_2_addr                      = 0xB6, // 182
    reg_MTC_Addr_2_Set_addr                  = 0xB7, // 183
    reg_MTC_Addr_2_Clear_addr                = 0xB8, // 184
    reg_MTC_Addr_3_addr                      = 0xB9, // 185
    reg_MTC_Addr_3_Set_addr                  = 0xBA, // 186
    reg_MTC_Addr_3_Clear_addr                = 0xBB, // 187
    reg_RTOS_Status0_addr                    = 0x90, // 144
